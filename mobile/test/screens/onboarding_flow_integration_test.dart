...
void main() {
  ...
  testWidgets(
    'full flow: Landing -> Signup -> Quiz -> Onboarding -> Dashboard',
    (tester) async {
      ...
      expect(
        find.textContaining('Basé sur ton profil Débutant'),
        findsOneWidget,
      );
  ...
  testWidgets('AppTheme is applied consistently across the full flow', (
    tester,
  ) async {
    SharedPreferences.setMockInitialValues({});
    final storageService = StorageService();
